...
class AdminApiController(
    ...
    fun routes(route: Route) {
        ...
        route.patch("/attractions/{id}/status") { if (!authorizationService.requireUpdate(call, ModuleKey.ATTRACTIONS)) return@patch; service.updateAttractionStatus(call.parameters["id"]!!.toLong(), call.receive<StatusRequest>().status); call.respond(ApiResponse<Unit>(true, "Attraction status updated")) }
        route.patch("/attractions/{id}/featured") { if (!authorizationService.requireUpdate(call, ModuleKey.ATTRACTIONS)) return@patch; service.updateAttractionFeatured(call.parameters["id"]!!.toLong(), call.receive<FeaturedRequest>().isFeatured); call.respond(ApiResponse<Unit>(true, "Attraction featured updated")) }
        route.delete("/attractions/{id}") { if (!authorizationService.requireDelete(call, ModuleKey.ATTRACTIONS)) return@delete; service.deleteAttraction(call.parameters["id"]!!.toLong()); call.respond(ApiResponse<Unit>(true, "Attraction deleted")) }

        route.get("/attractions/{id}/photos") { if (!authorizationService.requireRead(call, ModuleKey.PHOTOS)) return@get; call.respond(ApiResponse(true, "Photos loaded", service.listPhotos(call.parameters["id"]!!.toLong()))) }
        route.post("/attractions/{id}/photos") {
        ...
        route.patch("/photos/reorder") { if (!authorizationService.requireUpdate(call, ModuleKey.PHOTOS)) return@patch; service.reorderPhotos(call.receive<PhotoReorderRequest>().items); call.respond(ApiResponse<Unit>(true, "Photos reordered")) }
        route.delete("/photos/{id}") { if (!authorizationService.requireDelete(call, ModuleKey.PHOTOS)) return@delete; service.deletePhoto(call.parameters["id"]!!.toLong()); call.respond(ApiResponse<Unit>(true, "Photo deleted")) }

        route.get("/plans") { if (!authorizationService.requireRead(call, ModuleKey.PLANS)) return@get; call.respond(ApiResponse(true, "Plans loaded", service.listPlans())) }
        route.post("/plans") { if (!authorizationService.requireCreate(call, ModuleKey.PLANS)) return@post; call.respond(HttpStatusCode.Created, ApiResponse(true, "Plan created", mapOf("id" to service.createPlan(call.receive())))) }
        route.get("/plans/{id}") { if (!authorizationService.requireRead(call, ModuleKey.PLANS)) return@get; call.respond(ApiResponse(true, "Plan loaded", service.getPlan(call.parameters["id"]!!.toLong()))) }
        route.put("/plans/{id}") { if (!authorizationService.requireUpdate(call, ModuleKey.PLANS)) return@put; service.updatePlan(call.parameters["id"]!!.toLong(), call.receive()); call.respond(ApiResponse<Unit>(true, "Plan updated")) }
        route.patch("/plans/{id}/status") { if (!authorizationService.requireUpdate(call, ModuleKey.PLANS)) return@patch; service.updatePlanStatus(call.parameters["id"]!!.toLong(), call.receive<mapActive>().isActive); call.respond(ApiResponse<Unit>(true, "Plan status updated")) }
        ...
        route.get("/users/{id}") { if (!authorizationService.requireRead(call, ModuleKey.USER_MANAGEMENT)) return@get; call.respond(ApiResponse(true, "User loaded", service.getAdminUser(call.parameters["id"]!!.toLong()))) }
        route.put("/users/{id}") { if (!authorizationService.requireUpdate(call, ModuleKey.USER_MANAGEMENT)) return@put; service.updateAdminUser(call.parameters["id"]!!.toLong(), call.receive()); call.respond(ApiResponse<Unit>(true, "User updated")) }
        route.patch("/users/{id}/status") { if (!authorizationService.requireUpdate(call, ModuleKey.USER_MANAGEMENT)) return@patch; service.updateAdminStatus(call.parameters["id"]!!.toLong(), call.receive<mapStatus>().status); call.respond(ApiResponse<Unit>(true, "User status updated")) }
        route.delete("/users/{id}") { if (!authorizationService.requireDelete(call, ModuleKey.USER_MANAGEMENT)) return@delete; service.deleteAdminUser(call.parameters["id"]!!.toLong()); call.respond(ApiResponse<Unit>(true, "User deleted")) }
        route.post("/users/{id}/reset-password") { if (!authorizationService.requireUpdate(call, ModuleKey.USER_MANAGEMENT)) return@post; service.resetAdminPassword(call.parameters["id"]!!.toLong(), call.receive()); call.respond(ApiResponse<Unit>(true, "Password reset")) }
        route.get("/users/{id}/permissions") { if (!authorizationService.requireRead(call, ModuleKey.USER_MANAGEMENT)) return@get; call.respond(ApiResponse(true, "Permissions loaded", service.getAdminPermissions(call.parameters["id"]!!.toLong()))) }
        route.put("/users/{id}/permissions") { if (!authorizationService.requireUpdate(call, ModuleKey.USER_MANAGEMENT)) return@put; service.setAdminPermissions(call.parameters["id"]!!.toLong(), call.receive()); call.respond(ApiResponse<Unit>(true, "Permissions updated")) }
    }
